...
def extract_mixed_content(file_bytes_data, page_range):
    try:
        ...
        elements = partition_pdf(
            ...
            strategy="fast", # fast, hi-res, auto. 
...
if process_btn and uploaded_files and user_query:
    ...
    for pdf in pdf_files:
        ...
        # print("This is the total count of the pages: ", total_pages)
        page_chunks = chunk_pages(total_pages)
        # print("This is the created chunks: ", page_chunks)
        elements = process_pdf_chunks(pdf, page_chunks)
        print("Here is the extracted elements of the chunks: ", elements)
